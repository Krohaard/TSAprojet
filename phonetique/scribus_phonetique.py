...
def generate_header(total_pages=1, page_width=200, page_height=145):
    if total_pages==0:
        total_pages=1
    header = []
...
def generate_xml_from_syllables(syllables_with_colors, start_x=1000, start_y=500, step_y=205, page_width=200, page_height=145):
    """
...
syllabes_colorees = load_syllabes_as_tuples("phonetique.json")
#syllabes_colorees = []
lenght_card=200
height_card=145
